...
### Artifact Data (`google.genai.types.Part`)[¶](#artifact-data-googlegenaitypespart "Permanent link")
...
#### Listing Artifact Filenames (Tool Context Only)[¶](#listing-artifact-filenames-tool-context-only "Permanent link")
